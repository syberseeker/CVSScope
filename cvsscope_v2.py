...
if __name__ == "__main__":
    ...
    logo = (
        ...
        ------------------------------------------------------------------------------------------
        This is a simple vulnerability scanner leveraging the TCP SYN (Stealth) method via Nmap.
        Now supports CVSS v4.0 severity mapping and OSSTMM SCore with enhanced firewall evasion techniques.
        """ + Style.RESET_ALL
    )
